...
export default function RecommendationsPage() {
  ...
  return (
    <main>
      <HeroSection compact title="Personalized Sri Lanka recommendations from your trained tourism model." subtitle="Tell JourniQ AI what kind of trip you want. The system ranks destinations, stays, and experiences using the trained dataset, SVM model selection, seasonal demand, and preference matching." image="/images/sri-lanka-highlands.jpg" eyebrow={user ? `Welcome back, ${user.name}` : "AI recommendations"}>
